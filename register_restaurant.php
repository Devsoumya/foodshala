                ...
                <div class="card-body">
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="cost" class="form-control"  placeholder="Approximate Cost For Two Persons in rupees">
                        </div>
                        <div class="form-group">
                            <label><b>Cusine</b></label>
                            <div class="checkbox">
                            <label><input name="northIndian" type="checkbox" value="North Indian">North Indian</label>
                            </div>
                            <div class="checkbox">
                             <label><input name="chinese" type="checkbox" value="Chinese">Chinese</label>
                            </div>
                            <div class="checkbox">
                             <label><input name="southIndian" type="checkbox" value="South Indian" >South Indian</label>
                            </div>
                            <div class="checkbox">
